...
function Register() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-br from-green-50 to-green-100 dark:from-gray-900 dark:to-gray-800 transition-colors duration-500 p-6">
      <Helmet>
        <title>Register | PlantaCare</title>
      </Helmet>
        ...
        <form onSubmit={handleRegister} className="flex flex-col gap-6">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-sm text-gray-700 dark:text-gray-300">
              ...
              <Link
                to="/terms"
                className="font-semibold text-red-700 hover:text-amber-400"
              >
