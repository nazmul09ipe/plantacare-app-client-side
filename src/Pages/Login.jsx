...
function Login() {
  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center bg-gradient-to-br from-green-50 to-green-100 dark:from-gray-900 dark:to-gray-800 p-4 transition-colors duration-500">
      <Helmet>
        <title>Login | PlantaCare</title>
      </Helmet>
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-5 sm:gap-6">
          ...
          <div className="text-right">
            <Link
              ...
              state={{ email }}
              className="text-sm text-green-700 dark:text-green-400 hover:underline transition"
            >
              Forgot Password?
            </Link>
          </div>
